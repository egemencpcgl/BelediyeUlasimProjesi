...
{
    public partial class BelediyeUlasimProjesi : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstDepartureTime = table.Column<TimeSpan>(nullable: false),
                    LastDepartureTime = table.Column<TimeSpan>(nullable: false)
                },
                constraints: table =>
                {
